...
El documento original (data raw) tiene varios datos nulos, pero con el código que presento se ha completado. Es por eso que, como **ejercicio práctico**, dejo los datos crudos para que podais rellenar:
- IPF Points
- WILKS Points
